...
const features = [
  {
    ...
    description: "Streamlined submission for managers and self-referring users.",
  },
  {
    icon: ShieldCheck,
    ...
    <div className="min-h-svh w-screen bg-linear-to-br from-slate-950 via-[#0a0a0a] to-black text-white flex flex-col items-center justify-center p-8 overflow-hidden relative">
      ...
      <div className="w-full max-w-7xl space-y-16 relative z-10 mt-10">
        ...
        <div className="flex flex-col items-center text-center space-y-10">
          ...
          <Badge variant="secondary" className="backdrop-blur-md bg-cyan-950/30 border border-cyan-400/30 text-cyan-300 px-6 py-2 rounded-full text-base shadow-[0_0_15px_rgba(34,211,238,0.2)]">
          ...
          <div className="space-y-8 flex items-center justify-center flex-col">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight max-w-5xl leading-tight">
              ...
              <span className="bg-clip-text text-transparent bg-linear-to-r from-white via-slate-200 to-slate-400">
                The complete platform for 
              </span>
              <br />
              {/* FIX: Updated text gradient to 'bg-linear-to-r' */}
              <span className="bg-clip-text text-transparent bg-linear-to-r from-cyan-400 to-blue-500 drop-shadow-2xl">
                 Health Matters
              </span>
            </h1>
            
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl leading-relaxed font-light">
              Empowering practitioners, managers, and admins with a unified solution for referrals, clinical records, and outcome reporting.
            </p>
          ...
          {features.map((feature, idx) => (
            ...
            >
              <div className="p-3 rounded-xl bg-cyan-500/10 group-hover:bg-cyan-500/20 transition-colors">
                <feature.icon size={32} className="text-cyan-400 group-hover:text-cyan-300 transition-colors" />
              </div>
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-white group-hover:text-cyan-200 transition-colors">{feature.title}</h3>
                <p className="text-base text-slate-400 leading-relaxed group-hover:text-slate-300 transition-colors">{feature.description}</p>
              </div>
            </div>
          ))}
        </div>
